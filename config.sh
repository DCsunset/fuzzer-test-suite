AVAIL_PROJ=(boringssl c-ares freetype2 guetzli harfbuzz json lcms libarchive libjpeg libpng libssh libxml2 llvm-libcxxabi openssl-1.0.2d pcre2 proj4 re2 sqlite vorbis woff2)
